...
\clearpage
	...
	\begin{figure}[h!]
		\centering
		\fbox{\includegraphics[width=0.98\textwidth]{Images/A/Beet/BeetSim.pdf}}
	...
	\begin{figure}[h!]
		\centering
		\fbox{\includegraphics[trim =0cm 0 0cm 0cm,width=0.8\textwidth]{Images/A/Kus/Baseline.pdf}}
...
\begin{figure}[h!]
	...
	\caption{Mine B simulation schematic -- Main shaft air users}
...
\begin{figure}[h!]
	...
	\caption{Mine B simulation schematic -- Sub-shaft air users}
...
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[width=0.98\textwidth]{Images/A/105L/105LMain.pdf}}
	\caption{105 Level investigation -- Station}
	\label{fig: KUS Underground level layout}
\end{figure}
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[trim= 5cm 0 0cm 0, height=0.95\textheight]{Images/A/105L/105LWest.pdf}}
	\caption{105 Level investigation -- West operattions}
	\label{fig: KUS Underground West layout}
\end{figure}
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[height=0.95\textheight]{Images/A/105L/105LEast.pdf}}
	\caption{105 Level investigation -- East operation}

...
%%%%%% Refuge bays
	...
	\end{figure}
\chapter{\hspace{0.3cm}Model components verification tables}
\newpage
\begin{table}[h!]
	\centering
	\begin{tabular}{lccr}
...
\chapter{\hspace{0.3cm}Detailed mining level investigation diagrams}
\clearpage
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[trim= 4cm 0 1cm 0, height=0.8\textheight]{Images/A/105L/105LWest.pdf}}
	\caption{105L investigation: West}
	\label{fig: KUS Underground West layout}
\end{figure}
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[height=0.8\textheight]{Images/A/105L/105LEast.pdf}}

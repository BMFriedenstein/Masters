	...
	\subsection{Compressed air in operation}\label{key}
		...
		\subsubsection{Pneumatic rock drills}
			...
			\subsubsection{Processing plants}
				Processing plants are constructed near gold and mines. They are used to extract metal from the ore obtained from the mining operation. These plants utilize compressed air for various systems, processes and equipment. 
				\par 

...
\section{Background on deep level mining}
	\subsection{Mining profitability}
		...
		A considerable factor that is contributing to the increase in operational costs in South African gold mines has been the rise of electricity costs. As shown in \Cref{fig: Eskom tariffs}, the general cost of electricity has increased at a rate higher than inflation since 2008\footnotemark[1].

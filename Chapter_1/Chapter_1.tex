...
\section{Background on deep-level mining}
	\subsection{Mining profitability}
		...
		Another factor that has in recent years contributed considerably to the increase in operational costs in South African gold mines is electricity costs. As shown in \Cref{fig: Eskom tariffs}, the general cost of electricity has increased at a rate higher than inflation since 2008\footnotemark[1].
...
\section{Use of simulation in industry }
	\subsection{Background on industrial simulation}
		...
		\par 
		In \textit{ Handbook of Simulation: Principles, methodology, advances, applications, and practice,} \cite{banks1998handbook} the following advantages of the use of simulation in the industry are listed: %%% Chapter 1 of book
		\begin{itemize}

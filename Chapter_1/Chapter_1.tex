...
The supply of compressed air is highly energy demanding and costly process \cite{padachi2009energy}.  In 2010 the energy utilised for the production of compressed air contributed to approximately 17\% of total mining energy consumption.\cite{Eskom2010Energy} 
\subsection{Compressed air in operation}
	\paragraph{Operation schedule}
	On a typical mine, various operations will take place at different times of the day.Depending on the activity taking place many mines will control the pressure of the system to meet the requirements \cite{Kriel2014Masters,Marais2012PhD}. 
		\begin{figure}[h]
		\centering
		\input{Graphs/MiningSchedule}

...
\end{figure}
\par
The accuracy of the model was checked in more detail to ensure that each modelled parameter matched the actual measurement with high accuracy. Table \ref{} shows the average accuracy each measured simulation output in the model.
...
\section{Case study C: Periodic simulation analysis}
	...
	\begin{table}[h]
		...
		\begin{tabular}{ll}
			...
			\hline
		\end{tabular}
		\caption{Table showing the simulation inputs and outputs.}

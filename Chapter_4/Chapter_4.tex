...
\begin{figure}[h!]
	...
	\caption{Simplified process flow chart of the air network.}
...
With the data and knowledge gathered from  the investigation, a model was developed using the methodology discussed in Chapter 3.

...
\par 
The results of the simulation, shown, in \Cref{fig: CompSetpoints Results Beatrix}, indicated an average power reduction of 0.46 $MW$ \gls{pc}. This energy optimisation relates to R0.37m per year energy cost saving to the mine.
%%%%%
\clearpage 
\begin{figure}[!htbp]
	\centering

...
%	\subsubsection{Mine compressed air systems}
	...
	A structured simulation procedure is required to achieve the objectives of the study. 
		- Philip
		- Kriel masters\\
...
To get a relative error percentage, the equation is rewritten:	
 ...
 \end{table}
 	...
 	A software tool is required to create and execute the compressed air simulations. In literature variety software tools have been used to simulate industrial systems. A suitable software system for this study must be capable of accurate modelling of complex compressed air networks and the execution of transient simulation.
	\par
 	  From literature the following tools were identified that meet the criteria for this study: 
 	\begin{itemize}
 		\item \gls{ptb}
 		\item Flownex
		\item KYPipe GAS

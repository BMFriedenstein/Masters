...
Compressed air in mining is most commonly supplied by a centrifugal-type dynamic compressor \cite{Fouche2016Masters},\cite{Booysen2012Masters}. Compression in these machines is achieved as a result of the centrifugal force from the high speed rotation of impellers in air. Impeller rotation powered by a large electric motor. A higher pressure ratio is obtained through multi-stage impeller designs \cite{Fouche2016Masters}. The compression process is inefficient. Only about 5\% to 10\% of the input energy of the process is converted into energy that is used \cite{yang2009air}.

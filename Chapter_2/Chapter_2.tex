...
\subsubsection{Complex compressed air system}

-Mare et al 
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[trim =  -1.5cm 0.5cm -1.5cm 0.5cm ,width=\textwidth]{Images/2/mare/model}}
	\caption[Simulation model for a complex air network.]{Simulation model for a complex air network. Adapted from Mare \cite{}.}

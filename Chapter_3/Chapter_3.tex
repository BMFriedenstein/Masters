...
\section{Model development and verification}
	...
	\subsection{Simulation inputs}
		...
		\begin{figure}[h]
			...
			\caption{An example of two simulation periods, showing a changed compressor schedule.}
...
\section{Implementation of simulation method}
	\subsection{Preamble}
		Once a simulation has been developed and verified, the implementation of interventions and scenarios follows. In this section, the approach of implementation the simulation methodology, and analysis of simulation interventions  will be discussed.

...
set y2range [0:1]
set y2tics 0.25 nomirror

set size 1.3,0.75
set datafile separator ","
plot '2.csv' using 1:2 title "Baseline" with lines ls 1, \
     '2.csv' using 1:3 title "Scenario" with lines ls 4,\
	 '2.csv' using 1:4 title "Power saving" with impulses ls 18 axes x1y2, 
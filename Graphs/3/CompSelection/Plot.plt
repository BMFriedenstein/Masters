...
set style line 13 linecolor rgbcolor brown_075 linewidth @my_line_width pt 9
...
'Day1.csv' using 1:($6- 0.1) notitle with lines ls 1,\
'Day1.csv' using 1:($7- 0.1) notitle  with lines ls 1,\

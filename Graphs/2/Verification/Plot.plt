...
set style line 9 linecolor rgbcolor blue_075 linewidth 1.5 pt 13
...
set style line 12 linecolor rgbcolor brown_075 linewidth 1.5 pt 5
...
plot 'Data.csv' using 1:2 title "Actual power" with lines ls 1, \
     'Data.csv' using 1:3 title "Simulated power" with lines ls 4, \
	 'Data.csv' using 1:4 title "Error" with impulses ls 3 axes x1y2, \
	 'Data.csv' using 1:5 title "Average Actual" with lines ls 9,\
	 'Data.csv' using 1:6 title "Average Simulation" with lines ls 12,\
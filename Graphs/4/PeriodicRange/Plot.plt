...
set style line 1 lc rgbcolor blue_075 lt 1 lw 4 pt 7 pi -1 ps 0.5
...
set style line 4 linecolor rgbcolor brown_075 lt 1 lw 4 pt 7 pi -1 ps 0.5
...
set xdata time
set format x '%Y/%m/%d'
set xrange ["2016/09/01":"2016/12/13"]
set object 1 rect from first '2016/11/1', graph 0 to first '2016/11/30', graph 1
set object 1 rect fc rgb "#bababa" fillstyle solid 0.4
set label '\shortstack{Periodic simulation}' at first '2016/11/15', graph 0.9 center front 
set xlabel 'Date'
set ylabel "Power (kW)";
...
set xtics 2592000
set mxtics 30
set y2label '$Flow per Watt (kg/s/W)$'
set y2range [2:5]
...
plot 'Results.csv' using 1:2 title "Compressor 1 average power" with lp ls 1, \
     'Results.csv' using 1:4 title "System efficiency" with lp ls 4 axes x1y2